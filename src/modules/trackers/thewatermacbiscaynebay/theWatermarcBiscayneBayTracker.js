...
const propertyName = "TheWatermarcBiscayneBay";
class theWatermarkBiscayneBayTracker extends trackerInterface {
  constructor() {
    super();
  }
  ...
  async trackPrices() {
    ...
    try {
      ...
      const responseData = await axiosInstance.get(
        "https://www.thewatermarcbiscaynebay.com/en/apartments/residences/_jcr_content.residences.json"
      );
...
export default theWatermarkBiscayneBayTracker;
