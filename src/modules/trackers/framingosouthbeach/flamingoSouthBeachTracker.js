...
const propertyName = "FlamingoSouthBeach";
class flamingoSouthBeachTracker extends trackerInterface {
  constructor() {
    super();
  }
  ...
  async trackPrices() {
    ...
    try {
      ...
      const responseData = await axiosInstance.get(
        "https://www.flamingosouthbeach.com/en/apartments/residences/_jcr_content.residences.json"
      );
...
export default flamingoSouthBeachTracker;
